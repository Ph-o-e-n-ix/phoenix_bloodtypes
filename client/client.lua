                ...
                if distance < 3 then
                    ...
                    if distance < 2 then
                        ...
                        if IsControlJustReleased(0, 47) then 
                            local blood = exports["phoenix_blood"]:callbloodtype()
                            if blood == nil then 
                                test = true
                                TriggerServerEvent("phoenix:pay_fee", test)
                                startbloodtest()
...
AddEventHandler("phoenix:bloodtestitem", function()
    ...
    if distance < 3 then 
        local bloodtypetarget = exports["phoenix_blood"]:callbloodtypetarget()
        if bloodtypetarget == nil then
            ...
            Citizen.Wait(1000)
            local bloodtypetarget2 = exports["phoenix_blood"]:callbloodtypetarget()
...
AddEventHandler("phoenix:sendclosest_c", function(blooditem2)
    local playerped = PlayerPedId()
    TriggerEvent("phoenix:takeblood", blooditem2, true)
...
function startbloodtest()
    ...
    SetEntityHealth(PlayerPedId(), (health2 - 5))
    Citizen.Wait(58000)
...
function startbloodreserve(itemname, istargetplayer)
    ...
    ClearPedTasks(PlayerPedId())
    SetEntityHealth(playerped, (health + 100))
...
exports("setbloodtype", function(blood)
    if blood == nil then
        local type3 = exports["phoenix_blood"]:callbloodtype()
        if type3 == nil then
            TriggerServerEvent("phoenix:setbloodtype")
            Config.MSG(Translation[Config.Locale]["received_blootype"])
        end
    else 
        local type2 = exports["phoenix_blood"]:callbloodtype()
        if type2 == nil then
            print(blood)
